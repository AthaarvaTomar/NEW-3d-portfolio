...
using use = useUsing("use")`,
  ...
  [SkillNames.FLUTTER]: {
    ...
    label: "Flutter",
    shortDescription:
      "cross-platform UI framework for building beautiful native apps! 📱✨",
    color: "#02569B",
  ...
  [SkillNames.DART]: {
    ...
    label: "Dart",
    shortDescription:
      "optimized for client development, powering Flutter! 🎯⚡",
    color: "#0175C2",
  ...
  [SkillNames.RIVERPOD]: {
    ...
    label: "Riverpod",
    shortDescription:
      "reactive state-management library for Flutter and Dart! 🌊📦",
    color: "#02569B",
    icon: "https://riverpod.dev/img/logo.png",
  },
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Voyagex.AI",
    description: [
      "Building and maintaining responsive UI for a cross-platform enterprise application using Flutter, ensuring consistent performance across mobile, tablet, and desktop.",
      "Architecting state management using Riverpod and navigation flows using GoRouter, including nested routing and full-screen document viewers.",
      "Designing dynamic PDF reporting modules with conditional layouts and standardized formatting across multiple report types.",
      "Refactoring legacy UI screens into responsive, adaptive layouts to improve usability and long-term maintainability.",
      "Diagnosing and resolving data integration issues across core application workflows to improve system reliability.",
      "Collaborating with cross-functional teams to scope and implement new features — including role-based access control and dynamic form modules — from requirement to deployment.",
      "Following structured Git workflows for version control and code review while contributing to a large, actively-evolving production codebase.",
    ],
    skills: [
      SkillNames.FLUTTER,
      SkillNames.DART,
